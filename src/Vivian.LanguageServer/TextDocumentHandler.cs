...
namespace Vivian.VLanguageServer
{
    internal class TextDocumentHandler : ITextDocumentSyncHandler
    {
        ...
        private readonly DocumentSelector _documentSelector = new DocumentSelector(new DocumentFilter { Language = "Vivian" }
        );
        ...
        public async Task<Unit> Handle(DidChangeTextDocumentParams notification, CancellationToken token)
        {
            ...
            _lspHost.ClearDiagnostics(notification.TextDocument.Uri);
        ...
        public TextDocumentAttributes GetTextDocumentAttributes(DocumentUri uri) 
            => new TextDocumentAttributes(uri, "Vivian");
    }
}