    ...
    internal sealed class Lowerer : BoundTreeRewriter
        {
            ...
            protected override BoundStatement RewriteIfStatement(BoundIfStatement node)
            {
                if (node.ElseStatement == null)
                {
                    ...
                    var result = BoundNodeFactory.Block(
                        node.Syntax,
            ...
            protected override BoundExpression RewriteCompoundAssignmentExpression(BoundCompoundAssignmentExpression node)
            {
                ...
                return BoundNodeFactory.Assignment(
                    newNode.Syntax,
                    newNode.Variable,
                    BoundNodeFactory.Binary(
                        newNode.Syntax,
                        BoundNodeFactory.Variable(newNode.Syntax, newNode.Variable),
                        newNode.Op,
                        newNode.Expression
                    )
                );
            ...
            protected override BoundExpression RewriteCompoundFieldAssignmentExpression(BoundCompoundFieldAssignmentExpression node)
            {
                ...
                return BoundNodeFactory.Assignment(
                    ...
                    BoundNodeFactory.Binary(
                        newNode.Syntax,
                        BoundNodeFactory.Field(newNode.Syntax, newNode.StructInstance, newNode.StructMember),
                        newNode.Op,
                        newNode.Expression
                    )
                );
